...
static int JkFreqSet(int fd, unsigned int value)
{
	int i = 0;
	...
	len = pack_ui_frame(0X0091, 0, 4, (unsigned char *)&data, buffer);
	...
	printf(">>FreqSet (0X0091): [FREQ]=%u (0.01HZ), [SPEED]=%.02f (KM/H)\n", value, (float)value / 111.00F);
	return len;
}
...
void PrintUsage(void)
{
	...
	printf("Usage: %s -H [host] -P [connect port] -V [FREQ,0.01HZ,0~40000]\n", file);
