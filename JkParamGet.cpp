...
static int JkParamGet(int fd, unsigned int param)
{
	int i = 0;
	...
	len = pack_ui_frame(0X009E, 0, 4, (unsigned char *)&data, buffer);
...
void PrintUsage(void)
{
	...
	printf("Usage: %s -H [host] -P [connect port] -R [Param]\n", file);
	printf("Example: %s -H localhost -P 34000 -R 89\n", file), exit(1);
}
...
//////////////////////////////////////////////////////////////////////
	while ((c = getopt(argc, argv, "H:h:p:P:R:r:")) != -1)
	{
		switch (c)
		{
		default:
...
//////////////////////////////////////////////////////////////////////
	...
	JkParamGet(sd, (unsigned int)param);
...
//////////////////////////////////////////////////////////////////////
		...
		if (cmd == 0X009E)
		{
			...
			printf("<<ParamRsp (0X009E): [PARAM]=%u, [VALUE]=0X%06X,%u\n", rb[PT0_DATA_START], val, val);
			break;
		}
		printf(".");
	}
