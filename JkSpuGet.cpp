...
static int JkSpuGet(int fd)
{
	...
	if (-1 == fd)			return -1;
	len = pack_ui_frame(0X0094, 0, 4, (unsigned char *)&data, buffer);
...
void PrintUsage(void)
{
	...
	printf("Example: %s -H localhost -P 34000\n", file), exit(1);
}
...
//////////////////////////////////////////////////////////////////////
		...
		if (cmd == 0X0094)
		{
			...
			printf("<<SpuRsp (0X0094): [FREQ]=%u(0.1HZ), [RPM]=%.02f(KM/H)\n", val, (float)val * 60.00F / 10.00F);
			break;
		}
		printf(".");
	}
