...
static int JkParamSet(int fd, unsigned int param, unsigned int value)
{
	int i = 0;
...
void PrintUsage(void)
{
	...
	printf("Usage: %s -H [host] -P [connect port] -R [Param] -V [VALUE]\n", file);
	printf("Example: %s -H localhost -P 34000 -R 89 -V 900\n", file), exit(1);
}
...
//////////////////////////////////////////////////////////////////////
	while ((c = getopt(argc, argv, "H:h:p:P:R:r:V:v:")) != -1)
	{
		switch (c)
		{
		default:
...
//////////////////////////////////////////////////////////////////////
	...
	JkParamSet(sd, (unsigned int)param, (unsigned int)value);
...
//////////////////////////////////////////////////////////////////////
		...
		if (cmd == 0X009F)
		{
			val = BUILD_UINT32(rb[PT0_DATA_START + 3], rb[PT0_DATA_START + 2], rb[PT0_DATA_START + 1], 0);
			printf("<<ParamRsp (0X009F): [PARAM]=%u, [VALUE]=0X%06X,%u\n", rb[PT0_DATA_START], val, val);
			break;
		}
		printf(".");
	}
